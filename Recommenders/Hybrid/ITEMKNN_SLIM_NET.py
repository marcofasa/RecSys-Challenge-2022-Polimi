...
class ITEMKNN_SLIM_NET(BaseItemSimilarityMatrixRecommender):
    ...
    def __init__(self, URM_train, URM_rewatches):
        super(ITEMKNN_SLIM_NET, self).__init__(URM_train)

        self.URM_train = check_matrix(URM_train.copy(), 'csr')
        self.URM_rewatches= URM_train
        self.itemKNNCF = ItemKNNCFRecommender(URM_train)
        self.SLIM = SLIMElasticNetRecommender(URM_rewatches)
